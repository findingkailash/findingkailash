  ...
  return (
    <div
      style={{
        ...
        zIndex: 30,
        borderTop:
          variant === "ink" ? "1px solid rgba(250,246,238,0.08)" : "none",
      ...
      <Reveal>
        ...
        >
          <div style={{ maxWidth: 600 }}>
            ...
            <h2
              className="display"
              style={{ fontSize: "clamp(30px, 3.6vw, 48px)", margin: 0 }}
            >
              Three things we refuse to{" "}
              <em style={{ fontStyle: "italic", color: "var(--alpen-deep)" }}>
                cut corners on
              </em>
              .
            </h2>
          ...
          <p
            ...
            style={{ maxWidth: 360, fontSize: 15, lineHeight: 1.65 }}
          >
            The mountain doesn't negotiate. So neither do we — on local guides,
            on safety protocol, or on paperwork.
          </p>
        </div>
      </Reveal>
    ...
    <div className="wrap">
      <Reveal>
        ...
        >
          ...
          >
            On the Manaskhand circuit (and as add-ons to other yatras), we route
            you through the four most significant spiritual portals of the
            Kumaon Himalaya.
          </p>
        </div>
      </Reveal>
          ...
          <Reveal delay={i * 80} key={t.id}>
            ...
            >
              ...
              >
                <div
                  className="mono"
                  style={{ fontSize: 11, color: "var(--alpen-deep)" }}
                >
                  {t.sub}
                </div>
                <div
  ...
  >
    ...
    <div className="wrap" style={{ position: "relative", textAlign: "center" }}>
      <Reveal>
        ...
        >
          Ready to begin your{" "}
          <em style={{ fontStyle: "italic", color: "var(--saffron)" }}>
            sacred
          </em>{" "}
          quest?
        </h2>
        ...
        >
          Over 240 yatris have walked these trails with us. Join them in 2026 —
          permits are limited and the season is short.
        </p>
