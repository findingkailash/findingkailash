        ...
        >
          <div>
            <div className="eyebrow" style={{ marginBottom: 14 }}>
              Day-by-day · Adi Kailash &amp; Om Parvat
            </div>
            <h2
              className="display"
              style={{
            ...
            >
              Five days. Two mountains that will look back at you.
            </h2>
          </div>
          <div className="row" style={{ gap: 8 }}>
            ...
            <span className="chip">
              <i className="fa-solid fa-users" style={{ fontSize: 13 }} /> Max
              12
            </span>
            <span className="chip">
              <i
          ...
          <Reveal delay={i * 60} key={day.d}>
            ...
            >
              ...
              <div className="itinerary-meta">
                ...
                <div className="metric__label" style={{ marginTop: 6 }}>
                  {day.elev}
                </div>
              </div>
...
const Tiers = ({ onInquire }) => {
  const rows = [
    [
      "Price by pickup",
      "Delhi ₹35,000 · Haldwani ₹32,000 · Pithoragarh ₹25,000",
      "Delhi ₹55,000 · Haldwani ₹51,000 · Pithoragarh ₹30,000",
    ],
    ["Group size", "Up to 12 trekkers", "Up to 6 trekkers"],
    [
      "Stay",
      "Clean guesthouses, twin-share",
      "Best-available, mostly single-share",
    ],
      ...
      <div className="wrap">
        <Reveal>
          <div style={{ marginBottom: 40, maxWidth: 720 }}>
            ...
            <h2
              className="display"
              style={{ fontSize: "clamp(28px, 3.4vw, 42px)", margin: 0 }}
            >
          ...
          <div className="card" style={{ overflow: "hidden" }}>
            <div className="tiers-table">
                ...
                {cols.map((c) => (
                  <div
                    ...
                    style={{
                      ...
                      background:
                        c.name === "Premium" ? "var(--cream-2)" : "transparent",
                    }}
                  >
                    <div
                      style={{
              ...
              <div className="tiers-row tiers-row--footer">
                ...
                <div
                  className="tiers-cell tiers-cell--comfort"
                  style={{ padding: 26, borderLeft: "1px solid var(--line)" }}
                >
                  <button
      ...
      <div className="wrap">
        ...
        <div className="grid grid-2">
            ...
            <div className="card" style={{ padding: 28 }}>
              ...
              >
                {yes.map((x) => (
                  ...
                  >
                    <span style={{ color: "var(--pine)", marginTop: 2 }}>
                      <i
          ...
          <Reveal delay={100}>
            <div
              className="card"
              style={{ padding: 28, background: "var(--cream)" }}
            >
              <div
                style={{
                  display: "flex",
              ...
              >
                {no.map((x) => (
                  ...
                  >
                    <span style={{ color: "var(--alpen-deep)", marginTop: 2 }}>
                      <i
        ...
        <Reveal>
          ...
          >
            ...
            <p className="text-muted" style={{ maxWidth: 360 }}>
              Filter by trail. All photos are from our own expeditions — not
              stock.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal key={active}>
          ...
          <div className="gallery-grid">
            <Photo
              ...
              style={{ gridRow: "1 / 3", height: "100%", borderRadius: 14 }}
            />
            {secondary.map((src, i) => (
              <Photo
                key={src}
...
const TESTIMONIALS = [
  {
    ...
    quote:
      "I've trekked Everest base camp. Nothing prepared me for the silence at Nabhidhang when the ॐ first emerged through the cloud.",
  },
  {
    name: "Vikram & Ritu Saxena",
    from: "Delhi · Premium · 2023",
    quote:
      "We were the only ones at Parvati Kund at sunrise. The team had thought of every detail — even the rajma-chawal at base camp tasted like ghar.",
  },
  {
    name: "Joshua Pinto",
    from: "Mumbai · Darma Valley, 2024",
    quote:
      "Came for the photography, left with a guide who'd become a friend. Will book again, this time with my parents.",
  },
];
      ...
      >
        ...
        <Reveal delay={100}>
          <div>
            <div
              className="eyebrow"
              style={{ marginBottom: 14, color: "var(--saffron)" }}
            >
              About us
            </div>
            <h2
            ...
            >
              Finding Kailash was started by two cousins from Pithoragarh —
              children of the Vyas Valley who grew up listening to shepherd
              songs and walking ridge lines to school. We don't outsource. We
              guide every yatra ourselves, with people we've walked with for
              twenty years.
            </p>
            <p
              style={{
            ...
            >
              Our promise is small — small groups, small ego, big care. We'd
              rather you come back twice than refer us to ten.
            </p>
          ...
          <Reveal>
            <div style={{ position: "sticky", top: 100 }}>
              ...
              <p className="text-muted" style={{ fontSize: 15 }}>
                Don't see yours? Drop us a WhatsApp on +91 70374 78455 — we
...
const Booking = React.forwardRef((props, ref) => {
  ...
  const validate = () => {
    ...
    if (!/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(form.email))
      e.email = "Looks like the email isn't quite right.";
    setErrors(e);
            ...
            <div style={{ position: "sticky", top: 100 }}>
              ...
              >
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-phone" style={{ fontSize: 15 }} />
                  </span>
                  <div>
                    <div style={{ fontWeight: 700 }}>+91 70374 78455</div>
                    <div style={{ fontSize: 12.5, color: "var(--ink-soft)" }}>
                      Prashant Pal · founder · 9am–9pm IST
                    </div>
                  </div>
                </a>
                <a
          ...
          <Reveal delay={100}>
            {submitted ? (
              ...
              >
                ...
                >
                  We've got it. Expect a custom itinerary &amp; quote in your
                  inbox within 24 hours, often sooner. Until then — go for a
                  walk.
                </p>
              </div>
            ) : (
    ...
    >
      ...
      >
        <div>
          ...
          <p
            ...
            style={{ fontSize: 17, color: "var(--saffron)", marginBottom: 14 }}
          >
          ...
          >
            Soul-stirring expeditions to Adi Kailash &amp; Om Parvat — and
            across the Kumaon Himalaya. Run by people from these mountains.
          </p>
        </div>
        <div>
          <div
            className="metric__label"
            style={{ color: "rgba(250,246,238,0.55)", marginBottom: 14 }}
          >
            Trails
          </div>
          <ul
        ...
        <div>
          ...
          >
            ...
            <li>
              <a href="#permits">Permits &amp; prep</a>
            </li>
            <li>
              <a href="#faq">FAQ</a>
            </li>
            <li>
              <a href="#inquire">Plan my yatra</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          >
            <li>
              <a href="tel:+917037478455">
                <i className="fa-solid fa-phone" style={{ fontSize: 13 }} /> +91
                70374 78455
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="mailto:contact@findingkailash.com">
      ...
      >
        ...
        <div style={{ fontSize: 12, color: "rgba(250,246,238,0.45)" }}>
          © {new Date().getFullYear()} Finding Kailash · Pithoragarh,
          Uttarakhand · Made with हिमालय
        </div>
      </div>
      <div
        style={{
